...
<script>
  ...
  export default {
    ...
    methods: {
      handleScroll (event) {
        document.getElementById('logo-nav').style.maxWidth = '50px'
      },
        showNav: function(){
